...
public class HealthDocumentController {
    ...
    @PostMapping("/create")
    public String createDocument(@ModelAttribute HealthDocumentDTO document, RedirectAttributes redirectAttributes) {
        try {
    ...
    @PostMapping("/{id}/edit")
    public String updateDocument(@PathVariable Long id, @ModelAttribute HealthDocumentDTO document, RedirectAttributes redirectAttributes) {
        try {
